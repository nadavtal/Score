;(function() {
  ...
  // createInitialUsers()
  // addProfilePicToAllUsers()
    function addProfilePicToAllUsers(){
      var i = 1;
      usersService.getAllUsers()
        .then(function (users){
          console.log(users.data.data);
          for (let user  of users.data.data) {
            user.profileImageLink = 'https://randomuser.me/api/portraits/men/'+i+'.jpg';
            i++
            console.log(user)
            QueryService
            .query('PUT', 'users/' + user._id, null, user)
            .then(function(user){
